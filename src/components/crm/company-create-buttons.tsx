  ...
  return (
    <div className="grid gap-4 md:grid-cols-2">
      <div className="space-y-2">
        ...
        <Input id="modal-first-name" name="first_name" required placeholder="Mara" />
      </div>
      <div className="space-y-2">
        <Label htmlFor="modal-last-name">Nachname</Label>
        <Input id="modal-last-name" name="last_name" required placeholder="Schmidt" />
      </div>
      <div className="space-y-2">
        <Label htmlFor="modal-email">E-Mail</Label>
        <Input id="modal-email" name="email" type="email" placeholder="mara@example.com" />
      </div>
      <div className="space-y-2">
      ...
      <div className="space-y-2">
        ...
        <Input id="modal-job-title" name="job_title" placeholder="Head of People" />
      </div>
      <div className="space-y-2">
  ...
  return (
    <div className="grid gap-4 md:grid-cols-2">
      ...
      <div className="space-y-2">
        ...
        <Input id="modal-deal-probability" name="probability" type="number" min="0" max="100" placeholder="40" />
      </div>
      <div className="space-y-2">
